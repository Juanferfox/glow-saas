...
const DEV_APPOINTMENTS: Record<string, AppointmentWithDetails[]> = {
  ...
  "dev-fm-glow-studio": [
    ...
    },
    {
      ...
      cancel_reason: null,
      created_at: now.toISOString(),
      service_name: { es: "Limpieza Facial Sencilla" },
      specialist_name: "Ana García",
    },
    {
      id: "appt-fmg-3",
      ...
      cancel_reason: null,
      created_at: lastMonth.toISOString(),
      service_name: { es: "Set Natural de Pestañas" },
      specialist_name: "Ana García",
    },
    {
      id: "appt-fmg-4",
      ...
      specialist_id: "dev-sp-fmglow-1",
      service_id: "fmg-b1",
      scheduled_at: iso(lastMonth, 16),
      ends_at: iso(lastMonth, 17),
      status: "cancelled" as AppointmentStatus,
      notes: null,
      points_earned: 0,
      cancelled_at: lastMonth.toISOString(),
      cancel_reason: "No pude asistir por trabajo",
      created_at: lastMonth.toISOString(),
      service_name: { es: "Sueroterapia" },
      specialist_name: "Ana García",
    },
  ],
};
